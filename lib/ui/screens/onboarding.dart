    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // الـ Row الذي يحتوي على الأزرار والنقاط ملتصق تماماً بأسفل الشاشة
          Positioned(
            bottom: 0, // بدلاً من bottom: 40 → يلتصق بالأسفل خالص
            left: 0,
            right: 0,
            child: Container(
              ...
              color: Colors
                  .transparent, // أو Colors.black إذا أردت خلفية سوداء صلبة
              child: Row(
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          // مسافة سفلية أكبر لأن الأزرار الآن في أسفل الشاشة خالص
